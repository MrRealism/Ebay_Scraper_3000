...
discord_webhook_url = "https://discord.com/api/webhooks/1349548749206196295/d8tsfYiiiqbE3odgCzWG2nLeaTrc0CL5YuI60JzUC-sv_PRKatHGf83O0WvDwE16gTuP"  # Replace this with your actual webhook URL
...
def get_best_offers(search_query, max_price):
    ...
    url = f"https://www.ebay.com/sch/i.html?_nkw={search_query}&_ipg=240&rt=nc&LH_BIN=1"
    driver.get(url)
